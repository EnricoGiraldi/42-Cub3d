...
// The vulgar name of it displays author's frustration with often inadequate
// limitations of programming style he is required to follow.
typedef struct s_fuck_you_norminette
{
	t_scene	*scene;
	t_game	*game;
	t_map	*binds;
